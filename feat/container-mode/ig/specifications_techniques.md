# Volume 2 : Détail des transactions - Volet Téléradiologie v0.2.0
...
* Composition du segment ORC : Usage = Required / Cardinalité = [1..1]: ORC-2
  * ?: Placer Order Number
  * ?: 
* Composition du segment ORC : Usage = Required / Cardinalité = [1..1]: > ORC-2.1
  * ?: Entity Identifier
  * ?: Identifiant de la demande d'examen d'imagerie (Order Placer Number)
* Composition du segment ORC : Usage = Required / Cardinalité = [1..1]: > ORC-2.3
  * ?: Universal Id
  * ?: Identifiant de l'autorité d'affectation
* Composition du segment ORC : Usage = Required / Cardinalité = [1..1]: > ORC-2.4
  * ?: Universal Id Type
  * ?: 
...
* Composition du segment IPC : Usage = Required / Cardinalité = [1..1]: > IPC-2.3
  * ?: Universal Id
  * ?: OID du code system utilisé2.16.840.1.113883.6.1 (LOINC)
