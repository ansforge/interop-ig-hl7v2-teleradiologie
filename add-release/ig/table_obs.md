# Table TLR_OBSERVATION - Volet Téléradiologie v0.1.0
...
* Code: **REGION_ANATOMIQUE**
  * Libellé: Région anatomique de l’examen d’imagerie
  * CodeSystem: TLR_OBSERVATION
* Code: **PROTOCOLE_IMAGERIE**
  * Libellé: Protocole d’imagerie associé à l’examen
  * CodeSystem: TLR_OBSERVATION
* Code: **URL_PARTIELLE_VIEWER**
  * Libellé: URL partielle d’accès à la visionneuse d’imagerie DRIMbox
  * CodeSystem: TLR_OBSERVATION
* Code: **PRODUIT_ADMINISTRE**
  * Libellé: Informations relatives au produit administré lors de l’examen
  * CodeSystem: TLR_OBSERVATION
