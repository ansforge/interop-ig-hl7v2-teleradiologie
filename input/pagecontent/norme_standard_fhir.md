...
<table>
<caption><p>Table 18 : Concepts métier – Factorisation par
Concepts</p></caption>
<colgroup>
<col style="width: 32%" />
<col style="width: 56%" />
...
L'annulation d'une demande d'imagerie peut être réalisée grâce à la suppression d'une ressource, par exemple Appointment via une requête DELETE reposant sur l'intéraction "[delete]((https://build.fhir.org/http.html#delete)").
