...
{% include norme_standard-intro.md %}

<br>

{% include norme_standard-presTLR.md %}

<br>

{% include norme_standard-etude.md %}

<br>

{% include norme_standard-synthese.md %}

<br>

{% include norme_standard-analyseconclu.md %}
